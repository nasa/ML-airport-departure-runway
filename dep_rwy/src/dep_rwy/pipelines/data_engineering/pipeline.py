"""Pipeline for departure runway prediction data engineering
"""
...
def create_pipelines(**kwargs):
    ntv_pipeline = Pipeline(
        nodes=[
            ...
            node(
                func=prep_config_data,
                inputs=[
                    "config_data_set@CSV",
                ],
                outputs="clean_config_data",
                name="prep_config_data",
            ),
    ...
    tv_pipeline = Pipeline(
        nodes=[
            ...
            node(
                ...
                outputs="tv_df_1",
                name="merge_asof_etd_onto_tv_df",
                ),
